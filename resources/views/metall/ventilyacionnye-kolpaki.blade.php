...
@section('content')
    ...
    <?php $pages = 'Вентиляционные колпаки' ?>
    ...
    @component('components.breadcrumb')
        ...
        @slot('active') Вентиляционные колпаки @endslot
    ...
    <section class="posad">
        <div class="container">
            <div class="posad__inner">
                <h1 class="title">Вентиляционные колпаки</h1>
    ...
    <section class="page">
        <div class="container">
            <div class="page__inner">
                ...
                <h2 class="title">Вентиляционные колпаки</h2>
